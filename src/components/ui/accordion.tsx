...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "accordion-trigger flex flex-1 items-center justify-between py-5 text-base font-medium text-white transition-all hover:text-blue-400 cursor-pointer [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
