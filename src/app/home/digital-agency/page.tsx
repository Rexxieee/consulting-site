  ...
  return (
    <div className="min-h-screen bg-[#050510] relative isolate">
      ...
      <section className="px-6 pt-32 pb-20 max-w-7xl mx-auto">
        ...
        >
            {/* Main Headline Block */}
            <motion.div variants={itemVariants} className="lg:col-span-8 p-12 lg:p-16 rounded-[3rem] bg-gradient-to-br from-blue-600/10 to-transparent border border-white/10 flex flex-col justify-end min-h-[500px] relative overflow-hidden group">
               <div className="absolute top-8 right-8 w-24 h-24 rounded-full border border-blue-500/20 flex items-center justify-center animate-spin-slow">
                    <Circle className="w-12 h-12 text-blue-500/20 fill-blue-500/20" />
               </div>
               <div className="relative z-10">
                  <div className="section-marker mb-4">Digital Growth — 01</div>
                  ...
                  <p className="text-xl text-slate-400 max-w-md mb-8 font-semibold">
                    We combine strategic design and state-of-the-art software to help global brands dominate their industries.
                  </p>
                  <Button size="lg" className="rounded-full h-16 px-10 text-lg bg-blue-600 hover:bg-blue-700">
                    View Portfolio
            ...
            <motion.div variants={itemVariants} className="lg:col-span-4 p-8 rounded-[3rem] bg-blue-600 flex flex-col items-center justify-center text-center group cursor-pointer">
